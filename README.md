...
To fix the build error with libssl, temperoraly install libssl v1.0 to fix this with: sudo apt-get install libssl1.0-dev -y

Then, reinstall the latest version of openssl with: sudo apt-get install libssl-dev -y
